  ...
  },
  {
    ...
    items: [
      ...
      item(
        ...
        "Encuestas",
        MessageSquare,
        "Modera comentarios públicos de satisfacción.",
      ),
      item(
        PANEL_PATHS.delegacion,
        "examenes",
        "Exámenes",
        FileQuestion,
        "Monitorea exámenes diagnóstico de titulares.",
      ),
  ...
  },
  {
    ...
    items: [
      ...
      item(
        ...
        "Exámenes",
        FileQuestion,
        "Exámenes diagnóstico de tu área.",
      ),
      item(
        PANEL_PATHS.titular,
        "procesos",
  ...
  },
  {
    ...
    items: [
      ...
      item(
        ...
        "Exámenes",
        FileQuestion,
        "Monitorea exámenes diagnóstico del sistema.",
      ),
