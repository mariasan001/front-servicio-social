...
import { DataTableShell, DataTableToolbar } from "@/shared/components/DataTable";
import dataTableStyles from "@/shared/components/DataTable/DataTable.module.css";
...
export function AlumnoNotificacionesView({
  ...
  return (
    <section className={styles.page} aria-labelledby="alumno-notificaciones-title">
      ...
      <DataTableShell
        bodyClassName={dataTableStyles.bodyInset}
        toolbar={
          <DataTableToolbar
            actions={
