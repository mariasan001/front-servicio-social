...
import { getExamenMonitorAction } from "@/lib/actions/examenes-monitor.actions";
import {
  DataTable,
  DataTableActions,
  DataTableIconAction,
...
import { buildExamenResumenColumns, ExamenMonitorDetailModal } from "@/shared/components/examen";
...
export function ExamenesMonitorView({
  examenes,
