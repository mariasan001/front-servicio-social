...
| [`docs/FLUJOS.md`](./docs/FLUJOS.md) | Diagramas Mermaid de sesión, registro y proceso |
...
| [`docs/DEPLOY.md`](./docs/DEPLOY.md) | Despliegue, env vars, CI, rollback |
...
- **Mutaciones panel:** `runAuthorizedAction` + `revalidate{Rol}Section` — nunca `undefined` en payloads de server actions
